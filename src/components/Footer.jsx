    ...
    <div className="bg-slate-950 border-t-2  text-white p-8">
      <div className="flex justify-around ">
        <div className="w-1/3 px-6">
          ...
          <p className="text-m leading-7 font-light  text-white/30">
        ...
        <div className="w-1/3 text-center flex flex-col">
          ...
          <div className="text-m text-white/30 hover:text-white/50 flex items-center cursor-pointer justify-center mb-3">
            <span className="mr-1">
              <MailIcon />
            </span>
            <a 
